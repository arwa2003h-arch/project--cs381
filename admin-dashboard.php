  ...
  <main class="page-section">
    <div class="container">
      ...
      <section class="stats-grid">
        <div class="stat-card">
          <h3>Total Courses</h3>
          <p><?php echo htmlspecialchars($totalCourses); ?></p>
        </div>

        <div class="stat-card">
          <h3>Total Feedback</h3>
          <p><?php echo htmlspecialchars($totalFeedback); ?></p>
        </div>

        <div class="stat-card">
          <h3>Overall Average Rating</h3>
          <p><?php echo htmlspecialchars($overallAverage); ?></p>
        </div>
      </section>
          ...
          <table id="performanceTable">
            ...
            <tbody>
              <?php foreach ($coursePerformance as $course): ?>
                ...
                ?>
                <tr data-major="<?php echo htmlspecialchars(strtolower($course['major'])); ?>" data-performance="<?php echo htmlspecialchars($statusValue); ?>">
                  <td><?php echo htmlspecialchars($course["course_code"]); ?></td>
                  <td><?php echo htmlspecialchars($course["course_name"]); ?></td>
                  <td><?php echo htmlspecialchars($course["total_feedback"]); ?></td>
                  <td><?php echo htmlspecialchars($avgText); ?></td>
